            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full table-auto">
                    ...
                    <tbody class=" text-center">
                        ...
                        <tr>
                            <td><?php echo htmlspecialchars($row_compras['fecha']); ?></td>
                            <td>Q <?php echo htmlspecialchars(number_format($row_compras['total_pagado'], 2)); ?></td>
                            <td>
                                <a href="detalle-compras.php?id_venta=<?php echo htmlspecialchars($row_compras['id_venta']); ?>" title="Ver detalle de la compra">
