...
$sql = "INSERT INTO compras(encargado, metodo_de_pago, proveedor, total_compra, observaciones, createAt ) 
values ('$encargado','$metodo_de_pago', '$proveedor', '$total_compra', '$observaciones', now() )";
