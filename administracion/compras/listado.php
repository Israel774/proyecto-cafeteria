                            ...
                            <table id="datatablesSimple" class="table table-striped table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['fk_proveedor']; ?></td>
                                        <td><?php echo $row['total_compra']; ?></td>
                                        <td class="text-center">
                                            <a href="delete.php?id_compras=<?php echo $row['id_compras']; ?>"
                                                title="Borrar Registro">
                                                <button type="button" class="btn btn-outline-danger btn-xs btn-margin">
                                                    <i class="fa-solid fa-trash-can"></i>
                                                </button>
                                            </a>
                                            <a href="edit.php?id_compras=<?php echo $row['id_compras']; ?>"
                                                title="Editar Registro">
                                                <button type="button" class="btn btn-outline-warning btn-xs btn-margin">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </button>
                                            </a>
                                            <a href="view.php?id_compras=<?php echo $row['id_compras']; ?>" title="Ver Registro">
  <button type="button" class="btn btn-xs btn-outline-rosado">
    <i class="fa-solid fa-eye"></i>
  </button>
                                            <a href="viewD.php?id_compras=<?php echo $row['id_compras']; ?>"
                                                title="Ver Detalle">
                                                <button type="button" class="btn btn-outline-warning btn-xs btn-margin">
