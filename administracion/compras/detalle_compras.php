...
<head>
    ...
    <title>Detallar Compra - Cafetería Liceo Pre Universitario del Norte</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Detallar Compra</h1>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form id="formProducto" method="POST" action="createcc.php">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <input type="hidden" name="id_compra" value="<?php echo $id_compra; ?>" />
                                        <label for="fk_producto" class="form-label">Producto</label>
                                        <select class="form-select" id="fk_producto" name="fk_producto" required>
                                ...
                                <!-- Hidden inputs si necesitas pasar otros datos -->
