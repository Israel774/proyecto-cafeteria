        ...
        <tr>
            ...
            <td>
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <a href="edit.php?id=1" class="btn btn-warning" title="Editar">
        ...
        <tr>
            ...
            <td>
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <a href="edit.php?id=2" class="btn btn-warning" title="Editar">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <a href="edit.php?id=3" class="btn btn-warning" title="Editar">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </div>
            </td>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex justify-content-center gap-2">
                    ...
                    <a href="edit.php?id=4" class="btn btn-warning" title="Editar">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                </div>
            </td>
