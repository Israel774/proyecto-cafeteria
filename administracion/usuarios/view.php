            ...
            <form action="update.php" method="POST" class="card p-4 shadow">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="nombre" id="nombre" value="<?= $row['nombre'] ?>" disabled>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Apellido</label>
                        <input type="text" class="form-control" name="apellido" id="apellido" value="<?= $row['apellido'] ?>" disabled>
                    </div>

                    
                    <div class="col-md-6">
                        <label class="form-label">Modificación</label>
                        <input type="text" class="form-control" name="modificacion" id="modificacion" disabled>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Teléfono</label>
                        <input type="text" class="form-control" name="telefono" value="<?= $row['telefono'] ?>" disabled>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" name="correo" value="<?= $row['correo'] ?>" disabled>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="codigobarra" value="<?= $row['codigobarra'] ?>" disabled>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="contraseña" value="<?= $row['contraseña'] ?>" disabled>
                    </div>
